...
export default ({
  ...
  const demandClasses = classNames(
    ...
    {
      [classes.resourceItem__demand_red]: accumulatedHours?.totalHours && !accumulatedHours?.actualHours,
      [classes.resourceItem__demand_gray]: !accumulatedHours?.totalHours,
