...
const isEqual = (prevProps, nextProps) => {
  return prevProps.title === nextProps.title && prevProps.scheduleSettings === nextProps.scheduleSettings && prevProps.event === nextProps.event && prevProps.holiday === nextProps.holiday
};
