  ...
  return (
    <div className={style.logbookBlock}>
      ...
      <div className={style.generalBlock2}>
        ...
        />
        <div className={style.tooltipBlock}>
          <Tooltip title={'Calculate and show profitability - this checkbox is related with showing how much do the organization earn per each spent hour of his employee.'} />
        </div>
      </div>
      ...
      <div className={style.generalBlock3}>
        ...
        />
        <div className={style.tooltipBlock}>
          <Tooltip title={'Use approve flow on/off - enable the verification flow of the logbook entries, managers can approve or suspend each logbook entry which comes from the employees.)'} />
        </div>
      </div>
      <div className={style.formLine}></div>
      <div className={style.generalBlock3}>
