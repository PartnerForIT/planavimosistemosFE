  ...
  return (
    <SvgIcon viewBox='0 0 16 16' className={classes.root}>
      <g id="2383" data-name="2383" transform="translate(-47 -243)">
        ...
        <path id="Контур_13448" data-name="Контур 13448" d="M14625.123,9232.507l2.775,3.665,3.886-5.131" transform="translate(-14573.78 -8982.273)" fill="none" stroke="#fff" strokeLinejoin="round" strokeLinejoin="round" strokeWidth="1"/>
      </g>
    </SvgIcon>
  )
}
